...
const CAT_ICONS = { '식비': '🍚', '교통비': '🚇', '교통': '🚇', '문화/여가': '🎭', '문화': '🎭', '쇼핑': '🛒', '생활비': '🏠', '생활': '🏠', '의료비': '➕', '의료': '➕', '핸드폰요금': '📱', '통신비': '📱', '보험료': '🛡️', '월세': '🏢', '관리비': '🔑', '공과금': '💡', '세금': '🏛️', '카드값': '💳', '저축': '🐖', '적금': '🐖', '저축/적금': '🐖', '주식': '📊', '월급': '💰', '성과금/보너스': '🏆', '금융소득': '💹', '수입': '💸', '교육비': '📚', '렌탈/구독비': '📦', '운동/피트니스': '🏋️', '여행/숙박': '✈️', '기타': '📌' };
